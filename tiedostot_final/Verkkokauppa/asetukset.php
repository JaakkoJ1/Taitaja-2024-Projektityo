            ...
            <div class="content">
                <div class="header-row">
                    <h1 class="tauri-regular text-color-1">
                        <img class="img-logo" src="../images/logo.png" alt="Yrityksen logo">ASETUKSET
                    </h1>
                ...
                <div class="header-row-2">
                    <div>
                        ...
                        <form class="form-2" method="POST" action="">
                            <label for="new_password" class="zalando-sans text-color-2">Syötä uusi salasana</label>
                            <br>
                        ...
                        <form class="form-2" method="POST" action="">
                            <label for="confirm_password" class="zalando-sans text-color-2">Poista käyttäjä</label>
                            <br>
                            <input type="password" id="confirm_password" name="confirm_password" required placeholder="Vahvista salasanalla">
        ...
        <div id="myCarousel" class="carousel slide bg-carousel" data-ride="carousel" data-interval="5000" data-pause="false">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="../images/bg-2.jpeg" alt="Tausta kuva 1">
                </div>
                <div class="item">
                    <img src="../images/bg-3.jpeg" alt="Tausta kuva 2">
                </div>
                <div class="item">
