    ...
    <body>
            ...
            <div class="content">
                <div class="header-row">
                    <h1 class="tauri-regular text-color-1">
                        <img class="img-logo" src="../images/logo.png" alt="Yrityksen logo">Rekisteröidy
                    </h1>
                    <div>
                        <a style="margin-right: 35px; text-decoration: none;" class="zalando-sans button-2" href="index.php"><span class="glyphicon glyphicon-home"></span>Etusivu</a>
                ...
                <div class="header-row-2">
                    ...
                    <form class="form-1" method="POST" action="">
                        <label for="etunimi" class="zalando-sans text-color-2">Syötä etunimi</label>
                        <input type="text" id="etunimi" name="etunimi" required>
                        <br>
                        <br>
                        <label for="sukunimi" class="zalando-sans text-color-2">Syötä sukunimi</label>
                        <input type="text" id="sukunimi" name="sukunimi" required>
                        <br>
                        <br>
                        <label for="puhelinnumero" class="zalando-sans text-color-2">Syötä puhelinnumero</label>
                        <input type="text" id="puhelinnumero" name="puhelinnumero" required>
                        <br>
                        <br>
                        <label for="email" class="zalando-sans text-color-2">Syötä sähköposti</label>
                        <input type="email" id="email" name="email" required>
                        <br>
                        <br>
                        <label for="password" class="zalando-sans text-color-2">Syötä salasana</label>
                        ...
                        <br>
                        <br>
                        <p class="zalando-sans text-color-2">Kirjaudu sisään <a style="filter: brightness(75%);" class="link" href="kirjautuminen.php">täältä.</a></p>
                    </form>
                </div>
            </div>
        </div>
        <div id="myCarousel" class="carousel slide bg-carousel" data-ride="carousel" data-interval="5000" data-pause="false">
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img src="../images/bg-1.jpeg"  alt="Tausta kuva 4">
                </div>
            </div>
        </div>
    </body>
