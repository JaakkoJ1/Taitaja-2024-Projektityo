...
<head>
    ...
    <title>Taitaja 2024 Semifinaali - Kirjautuminen (Työntekijä)</title>
            ...
            <div class="content">
                <div class="header-row">
                    <h1 class="tauri-regular text-color-1">
                        <img class="img-logo" src="../images/logo.png" alt="Yrityksen logo">KIRJAUDU SISÄÄN (TYÖNTEKIJÄ)
                    </h1>
                </div>
                <div class="header-row-2">
                    <div>
                        <h1 class="tauri-regular text-color-1">Työntekijä kirjautuminen</h1>
                        <br>
