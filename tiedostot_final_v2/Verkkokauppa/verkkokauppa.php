...
<div class="test">
    <div class="header-row">
        <h1 class="tauri-regular text-color-1">
            <img class="img-logo" src="../images/logo.png" alt="Yrityksen logo">TUOTTEET
        </h1>
        <div>
            <a style="margin-right: 20px; text-decoration: none;" class="zalando-sans button-2" href="index.php"><span class="glyphicon glyphicon-home"></span>Etusivu</a>
            <a style="margin-right: 20px; text-decoration: none;" class="zalando-sans button-2" href="omat_tilaukset.php"></span>Omat tilaukset</a>
...
<div class="container" style="padding-top: 20px;">
    <form method="GET" class="form-inline">
        <label for="hae_tuotetta" class="zalando-sans text-color-2">Hae tuotetta</label>
        <br>
        <input type="text" id="hae_tuotetta" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="&#xf002; Hae tuotetta" class="form-control zalando-sans" style="font-family: FontAwesome, Arial; font-style: normal; margin-right: 5px;">
